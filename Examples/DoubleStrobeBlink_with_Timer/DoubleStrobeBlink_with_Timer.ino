// clang-format off
/*
 * Blink with SpinTimer, special blink pattern: 2 short pulses, long pause,
 * repeat.
 *
...
SpinTimer blinkTimer(BLINK_TIME_MILLIS, 0, SpinTimer::IS_RECURRING,
                     SpinTimer::IS_AUTOSTART);
SpinTimer offTimer(OFF_TIME_MILLIS, 0, SpinTimer::IS_NON_RECURRING,
...
class BlinkTimerAction : public SpinTimerAction {
  ...
  public:
   BlinkTimerAction(SpinTimer& blinkTimer, SpinTimer& offTimer)
       : m_count(0), m_blinkTimer(blinkTimer), m_offTimer(offTimer) {}
...
class OffTimerAction : public SpinTimerAction {
  ...
  public:
   OffTimerAction(SpinTimer& blinkTimer) : m_blinkTimer(blinkTimer) {}
